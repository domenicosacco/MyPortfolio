...
<div>
 ...
 <form class="user_data_form" action="index.php?category=user&page=Change_Password.php" method="POST">
     <input type="text" name="new_password" id="description_input" class="input_text" placeholder="Enter new password" required> <br/>
     <input id="change_password_button" type="submit" value="Change Password" name="change_password"> <br/>
 </form>
